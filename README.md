...
Descarga la última versión desde la [página de releases](https://github.com/agdalasv/secureai/releases) o directamente el [instalador MSI](https://github.com/agdalasv/secureai/releases/download/v2.0.0/SecureAI-2.0.0.msi).
